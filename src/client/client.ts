...
// #region Data Channel
function DataChannelStateChange(label:string, channel:RTCDataChannel) {
...
let onConnect: (value?:unknown) => void;
...
const btnStart = <HTMLButtonElement>document.getElementById("btnStart");
